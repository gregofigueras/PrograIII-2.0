...
/**
 * @author Clase abstracta que representa un Servicio
 */
public abstract class Servicio implements Cloneable {
	...
	/**
	 * Metodo abstracto que calcula el costo neto (con promociones aplicadas) de un
	 * servicio
	 * 
	...
	public String toString() {
		return "Servicio [precioBase=" + precioBase + ", cantCamaras=" + cantCamaras + ", cantBotonAP=" + cantBotonAP
