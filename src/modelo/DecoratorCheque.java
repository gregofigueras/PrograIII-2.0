...
public class DecoratorCheque extends DecoratorPagos {
	 ...
	 * 
	 * @param encapsulado: Encapsulado de la clase <b>Pre:</b> El encapsulado debe
	...
	public double getCostoServicios() {
		return this.encapsulado.getCostoServicios() * 1.1;// Aplica promo sobre el TOTAL que debe pagar un abonado por
															// todos sus servicios
	}
